state("Dandara")
{
    float playedTime : "mono.dll", 0x001F72C0, 0x0, 0x54, 0x7B8, 0x8, 0x4c;
    //string255 currentRoomNameID : "mono.dll", 0x001F72C0, 0x0, 0x54, 0x7B8, 0x8, 0x38, 0xc;
    string255 currentScene : "mono.dll", 0x001F72C0, 0x0, 0x54, 0x7B8, 0x8, 0x3c, 0xc;
    string255 baseCampScene : "mono.dll", 0x001F72C0, 0x0, 0x54, 0x7B8, 0x8, 0x48, 0xc;
    byte isTransitioning : "mono.dll", 0x001F72C0, 0x0, 0x54, 0x7B8, 0x8, 0x65;
