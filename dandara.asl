...
startup {
	...
	settings.Add("split_current_scene", false, "Split on current scene name");
	...
	AddEventSplit(0x32, "Boss_Kill_1", false, "Killed Augustus");
	...
	AddEventSplit(0x65, "PU_Stone_Remembrance", false, "Got rock of Remembrance");
	AddEventSplit(0x66, "PU_Stone_Intention", false, "Got stone of Intention");
	AddEventSplit(0x67, "PU_Stone_Dreams", false, "Got pearl of dreams");
	AddEventSplit(0x6C, "PU_DLCF_FinalKey", false, "");
	AddEventSplit(0x6E, "PU_Health", false, "");
	AddEventSplit(0x6F, "PU_Ammo", false, "");
	AddEventSplit(0x70, "PU_HealthFlask", false, "Got first health flask");
	...
	AddEventSplit(0x96, "Weapon_Missile", false, "Got missile weapon");
	AddEventSplit(0x97, "Weapon_EnergyBall", false, "");
	AddEventSplit(0x98, "Weapon_Remembrance", false, "Got memory shaft");
...
init {
	vars.currentStoryEvents = new List<int>();
}
