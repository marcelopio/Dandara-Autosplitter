state("Dandara")
{
	float playedTime : "UnityPlayer.dll", 0x004F5470, 0x0, 0x8, 0x4c;
	//string255 currentRoomNameID : "UnityPlayer.dll", 0x004F5470, 0x0, 0x8, 0x38, 0xc;
	string255 currentScene : "UnityPlayer.dll", 0x004F5470, 0x0, 0x8, 0x3c, 0xc;
	string255 baseCampScene : "UnityPlayer.dll", 0x004F5470, 0x0, 0x8, 0x48, 0xc;
	byte isTransitioning : "UnityPlayer.dll", 0x004F5470, 0x0, 0x8, 0x65;
