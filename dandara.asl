...
state("Dandara", "epic")
{
    int gameManager : "UnityPlayer.dll", 0x0107D170, 0x18, 0x8, 0x54, 0x7C0, 0x0, 0x0;
    float playedTime : "UnityPlayer.dll", 0x0107D170, 0x18, 0x8, 0x54, 0x7C0, 0x0, 0x4c;
    //string255 currentRoomNameID : "UnityPlayer.dll", 0x0107D170, 0x18, 0x8, 0x54, 0x7C0, 0x0, 0x38, 0xc;
    string255 currentScene : "UnityPlayer.dll", 0x0107D170, 0x18, 0x8, 0x54, 0x7C0, 0x0, 0x3c, 0xc;
    string255 baseCampScene : "UnityPlayer.dll", 0x0107D170, 0x18, 0x8, 0x54, 0x7C0, 0x0, 0x48, 0xc;
    byte isTransitioning : "UnityPlayer.dll", 0x0107D170, 0x18, 0x8, 0x54, 0x7C0, 0x0, 0x65;
